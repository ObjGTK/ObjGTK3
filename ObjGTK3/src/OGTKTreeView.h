 ...
 * @param path a pointer to receive a #GtkTreePath or %NULL
 * @param iter a pointer to receive a #GtkTreeIter or %NULL
 ...
 * @param userData User data to be passed to @func, or %NULL
 ...
 *
 * @param gridLines a #GtkTreeViewGridLines value indicating which grid lines to
 * enable.
 */
 ...
 * @param searchUserData user data to pass to @search_equal_func, or %NULL
 * @param searchDestroy Destroy notifier for @search_user_data, or %NULL
 */
