 ...
 * @param xoffset location to return x offset of a cell relative to @cell_area, or %NULL
 * @param yoffset location to return y offset of a cell relative to @cell_area, or %NULL
