...
{
	return gtk_gesture_multi_press_get_area(GTK_GESTURE_MULTI_PRESS([self GOBJECT]), rect);
}

- (void)setArea:(const GdkRectangle*)rect
{
	gtk_gesture_multi_press_set_area(GTK_GESTURE_MULTI_PRESS([self GOBJECT]), rect);
}
