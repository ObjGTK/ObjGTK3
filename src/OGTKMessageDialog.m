...
- (id)initWithParent:(OGTKWindow*)parent andFlags:(GtkDialogFlags)flags andType:(GtkMessageType)type andButtons:(GtkButtonsType)buttons andMarkup:(OFString*)markup
{
...
- (id)initWithParent:(OGTKWindow*)parent andFlags:(GtkDialogFlags)flags andType:(GtkMessageType)type andButtons:(GtkButtonsType)buttons andMessage:(OFString*)message
{
...
- (OGTKWidget*)getImage
{
	return [[OGTKWidget alloc] initWithGObject:(GObject*)gtk_message_dialog_get_image(GTK_MESSAGE_DIALOG([self GOBJECT]))];
}

- (OGTKWidget*)getMessageArea
{
	return [[OGTKWidget alloc] initWithGObject:(GObject*)gtk_message_dialog_get_message_area(GTK_MESSAGE_DIALOG([self GOBJECT]))];
}
