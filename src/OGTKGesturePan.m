...
- (id)initWithWidget:(OGTKWidget*)widget andOrientation:(GtkOrientation)orientation
{
...
{
	return gtk_gesture_pan_get_orientation(GTK_GESTURE_PAN([self GOBJECT]));
}

- (void)setOrientation:(GtkOrientation)orientation
{
	gtk_gesture_pan_set_orientation(GTK_GESTURE_PAN([self GOBJECT]), orientation);
}
