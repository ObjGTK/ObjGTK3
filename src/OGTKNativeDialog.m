...
- (bool)getModal
{
	return gtk_native_dialog_get_modal(GTK_NATIVE_DIALOG([self GOBJECT]));
}
...
- (bool)getVisible
{
	return gtk_native_dialog_get_visible(GTK_NATIVE_DIALOG([self GOBJECT]));
}
...
{
	gtk_native_dialog_set_modal(GTK_NATIVE_DIALOG([self GOBJECT]), modal);
}
