...
- (bool)getInverted
{
	return gtk_level_bar_get_inverted(GTK_LEVEL_BAR([self GOBJECT]));
}
...
{
	return gtk_level_bar_get_offset_value(GTK_LEVEL_BAR([self GOBJECT]), [name UTF8String], value);
}
...
{
	gtk_level_bar_set_inverted(GTK_LEVEL_BAR([self GOBJECT]), inverted);
}
