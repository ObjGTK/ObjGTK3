...
- (bool)getVelocityWithVelocityX:(gdouble*)velocityX andVelocityY:(gdouble*)velocityY
{
	return gtk_gesture_swipe_get_velocity(GTK_GESTURE_SWIPE([self GOBJECT]), velocityX, velocityY);
}
