...
{
	return gtk_entry_get_activates_default(GTK_ENTRY([self GOBJECT]));
}
...
- (bool)getHasFrame
{
	return gtk_entry_get_has_frame(GTK_ENTRY([self GOBJECT]));
}

- (bool)getIconActivatable:(GtkEntryIconPosition)iconPos
{
	return gtk_entry_get_icon_activatable(GTK_ENTRY([self GOBJECT]), iconPos);
}
...
{
	return gtk_entry_get_icon_sensitive(GTK_ENTRY([self GOBJECT]), iconPos);
}
...
{
	return gtk_entry_get_overwrite_mode(GTK_ENTRY([self GOBJECT]));
}
...
- (bool)getVisibility
{
	return gtk_entry_get_visibility(GTK_ENTRY([self GOBJECT]));
}
...
{
	return gtk_entry_im_context_filter_keypress(GTK_ENTRY([self GOBJECT]), event);
}
...
{
	gtk_entry_set_activates_default(GTK_ENTRY([self GOBJECT]), setting);
}
...
{
	gtk_entry_set_has_frame(GTK_ENTRY([self GOBJECT]), setting);
}

- (void)setIconActivatableWithIconPos:(GtkEntryIconPosition)iconPos andActivatable:(bool)activatable
{
	gtk_entry_set_icon_activatable(GTK_ENTRY([self GOBJECT]), iconPos, activatable);
}
...
{
	gtk_entry_set_icon_sensitive(GTK_ENTRY([self GOBJECT]), iconPos, sensitive);
}
...
{
	gtk_entry_set_overwrite_mode(GTK_ENTRY([self GOBJECT]), overwrite);
}
...
{
	gtk_entry_set_visibility(GTK_ENTRY([self GOBJECT]), visible);
}
