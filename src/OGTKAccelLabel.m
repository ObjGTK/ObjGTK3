...
- (OGTKWidget*)getAccelWidget
{
	return [[OGTKWidget alloc] initWithGObject:(GObject*)gtk_accel_label_get_accel_widget(GTK_ACCEL_LABEL([self GOBJECT]))];
}
...
- (bool)refetch
{
	return gtk_accel_label_refetch(GTK_ACCEL_LABEL([self GOBJECT]));
}
