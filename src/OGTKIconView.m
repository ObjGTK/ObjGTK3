...
{
	return gtk_icon_view_get_activate_on_single_click(GTK_ICON_VIEW([self GOBJECT]));
}

- (bool)getCellRectWithPath:(GtkTreePath*)path andCell:(GtkCellRenderer*)cell andRect:(GdkRectangle*)rect
{
	return gtk_icon_view_get_cell_rect(GTK_ICON_VIEW([self GOBJECT]), path, cell, rect);
}
...
{
	return gtk_icon_view_get_cursor(GTK_ICON_VIEW([self GOBJECT]), path, cell);
}
...
{
	return gtk_icon_view_get_dest_item_at_pos(GTK_ICON_VIEW([self GOBJECT]), dragX, dragY, path, pos);
}
...
{
	return gtk_icon_view_get_item_at_pos(GTK_ICON_VIEW([self GOBJECT]), x, y, path, cell);
}
...
- (bool)getReorderable
{
	return gtk_icon_view_get_reorderable(GTK_ICON_VIEW([self GOBJECT]));
}
...
{
	return gtk_icon_view_get_tooltip_context(GTK_ICON_VIEW([self GOBJECT]), x, y, keyboardTip, model, path, iter);
}

- (bool)getVisibleRangeWithStartPath:(GtkTreePath**)startPath andEndPath:(GtkTreePath**)endPath
{
	return gtk_icon_view_get_visible_range(GTK_ICON_VIEW([self GOBJECT]), startPath, endPath);
}
...
{
	return gtk_icon_view_path_is_selected(GTK_ICON_VIEW([self GOBJECT]), path);
}
...
{
	gtk_icon_view_scroll_to_path(GTK_ICON_VIEW([self GOBJECT]), path, useAlign, rowAlign, colAlign);
}
...
{
	gtk_icon_view_set_activate_on_single_click(GTK_ICON_VIEW([self GOBJECT]), single);
}
...
{
	gtk_icon_view_set_cursor(GTK_ICON_VIEW([self GOBJECT]), path, cell, startEditing);
}
...
{
	gtk_icon_view_set_reorderable(GTK_ICON_VIEW([self GOBJECT]), reorderable);
}
