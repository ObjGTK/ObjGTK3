...
{
	return gtk_text_view_backward_display_line(GTK_TEXT_VIEW([self GOBJECT]), iter);
}

- (bool)backwardDisplayLineStart:(GtkTextIter*)iter
{
	return gtk_text_view_backward_display_line_start(GTK_TEXT_VIEW([self GOBJECT]), iter);
}
...
{
	return gtk_text_view_forward_display_line(GTK_TEXT_VIEW([self GOBJECT]), iter);
}

- (bool)forwardDisplayLineEnd:(GtkTextIter*)iter
{
	return gtk_text_view_forward_display_line_end(GTK_TEXT_VIEW([self GOBJECT]), iter);
}

- (bool)getAcceptsTab
{
	return gtk_text_view_get_accepts_tab(GTK_TEXT_VIEW([self GOBJECT]));
}
...
{
	return gtk_text_view_get_cursor_visible(GTK_TEXT_VIEW([self GOBJECT]));
}
...
- (bool)getEditable
{
	return gtk_text_view_get_editable(GTK_TEXT_VIEW([self GOBJECT]));
}
...
{
	return gtk_text_view_get_iter_at_location(GTK_TEXT_VIEW([self GOBJECT]), iter, x, y);
}

- (bool)getIterAtPositionWithIter:(GtkTextIter*)iter andTrailing:(gint*)trailing andX:(gint)x andY:(gint)y
{
	return gtk_text_view_get_iter_at_position(GTK_TEXT_VIEW([self GOBJECT]), iter, trailing, x, y);
}
...
- (bool)getMonospace
{
	return gtk_text_view_get_monospace(GTK_TEXT_VIEW([self GOBJECT]));
}

- (bool)getOverwrite
{
	return gtk_text_view_get_overwrite(GTK_TEXT_VIEW([self GOBJECT]));
}
...
{
	return gtk_text_view_im_context_filter_keypress(GTK_TEXT_VIEW([self GOBJECT]), event);
}
...
{
	return gtk_text_view_move_mark_onscreen(GTK_TEXT_VIEW([self GOBJECT]), mark);
}

- (bool)moveVisuallyWithIter:(GtkTextIter*)iter andCount:(gint)count
{
	return gtk_text_view_move_visually(GTK_TEXT_VIEW([self GOBJECT]), iter, count);
}

- (bool)placeCursorOnscreen
{
	return gtk_text_view_place_cursor_onscreen(GTK_TEXT_VIEW([self GOBJECT]));
}
...
{
	return gtk_text_view_scroll_to_iter(GTK_TEXT_VIEW([self GOBJECT]), iter, withinMargin, useAlign, xalign, yalign);
}
...
{
	gtk_text_view_scroll_to_mark(GTK_TEXT_VIEW([self GOBJECT]), mark, withinMargin, useAlign, xalign, yalign);
}

- (void)setAcceptsTab:(bool)acceptsTab
{
	gtk_text_view_set_accepts_tab(GTK_TEXT_VIEW([self GOBJECT]), acceptsTab);
}
...
{
	gtk_text_view_set_cursor_visible(GTK_TEXT_VIEW([self GOBJECT]), setting);
}

- (void)setEditable:(bool)setting
{
	gtk_text_view_set_editable(GTK_TEXT_VIEW([self GOBJECT]), setting);
}
...
{
	gtk_text_view_set_monospace(GTK_TEXT_VIEW([self GOBJECT]), monospace);
}

- (void)setOverwrite:(bool)overwrite
{
	gtk_text_view_set_overwrite(GTK_TEXT_VIEW([self GOBJECT]), overwrite);
}
...
{
	return gtk_text_view_starts_display_line(GTK_TEXT_VIEW([self GOBJECT]), iter);
}
