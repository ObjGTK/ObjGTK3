...
- (bool)getDeleted
{
	return gtk_text_child_anchor_get_deleted(GTK_TEXT_CHILD_ANCHOR([self GOBJECT]));
}

- (GList*)getWidgets
{
	return gtk_text_child_anchor_get_widgets(GTK_TEXT_CHILD_ANCHOR([self GOBJECT]));
}
