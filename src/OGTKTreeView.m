...
{
	return gtk_tree_view_collapse_row(GTK_TREE_VIEW([self GOBJECT]), path);
}
...
{
	return gtk_tree_view_expand_row(GTK_TREE_VIEW([self GOBJECT]), path, openAll);
}
...
{
	return gtk_tree_view_get_activate_on_single_click(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_dest_row_at_pos(GTK_TREE_VIEW([self GOBJECT]), dragX, dragY, path, pos);
}
...
{
	return gtk_tree_view_get_enable_search(GTK_TREE_VIEW([self GOBJECT]));
}

- (bool)getEnableTreeLines
{
	return gtk_tree_view_get_enable_tree_lines(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_fixed_height_mode(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_headers_clickable(GTK_TREE_VIEW([self GOBJECT]));
}

- (bool)getHeadersVisible
{
	return gtk_tree_view_get_headers_visible(GTK_TREE_VIEW([self GOBJECT]));
}

- (bool)getHoverExpand
{
	return gtk_tree_view_get_hover_expand(GTK_TREE_VIEW([self GOBJECT]));
}

- (bool)getHoverSelection
{
	return gtk_tree_view_get_hover_selection(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_path_at_pos(GTK_TREE_VIEW([self GOBJECT]), x, y, path, column, cellX, cellY);
}

- (bool)getReorderable
{
	return gtk_tree_view_get_reorderable(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_rubber_banding(GTK_TREE_VIEW([self GOBJECT]));
}

- (bool)getRulesHint
{
	return gtk_tree_view_get_rules_hint(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_show_expanders(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_get_tooltip_context(GTK_TREE_VIEW([self GOBJECT]), x, y, keyboardTip, model, path, iter);
}
...
{
	return gtk_tree_view_get_visible_range(GTK_TREE_VIEW([self GOBJECT]), startPath, endPath);
}
...
{
	return gtk_tree_view_is_blank_at_pos(GTK_TREE_VIEW([self GOBJECT]), x, y, path, column, cellX, cellY);
}

- (bool)isRubberBandingActive
{
	return gtk_tree_view_is_rubber_banding_active(GTK_TREE_VIEW([self GOBJECT]));
}
...
{
	return gtk_tree_view_row_expanded(GTK_TREE_VIEW([self GOBJECT]), path);
}
...
{
	gtk_tree_view_scroll_to_cell(GTK_TREE_VIEW([self GOBJECT]), path, column, useAlign, rowAlign, colAlign);
}
...
{
	gtk_tree_view_set_activate_on_single_click(GTK_TREE_VIEW([self GOBJECT]), single);
}
...
{
	gtk_tree_view_set_cursor(GTK_TREE_VIEW([self GOBJECT]), path, focusColumn, startEditing);
}
...
{
	gtk_tree_view_set_cursor_on_cell(GTK_TREE_VIEW([self GOBJECT]), path, focusColumn, focusCell, startEditing);
}
...
{
	gtk_tree_view_set_enable_search(GTK_TREE_VIEW([self GOBJECT]), enableSearch);
}

- (void)setEnableTreeLines:(bool)enabled
{
	gtk_tree_view_set_enable_tree_lines(GTK_TREE_VIEW([self GOBJECT]), enabled);
}
...
{
	gtk_tree_view_set_fixed_height_mode(GTK_TREE_VIEW([self GOBJECT]), enable);
}
...
{
	gtk_tree_view_set_headers_clickable(GTK_TREE_VIEW([self GOBJECT]), setting);
}

- (void)setHeadersVisible:(bool)headersVisible
{
	gtk_tree_view_set_headers_visible(GTK_TREE_VIEW([self GOBJECT]), headersVisible);
}

- (void)setHoverExpand:(bool)expand
{
	gtk_tree_view_set_hover_expand(GTK_TREE_VIEW([self GOBJECT]), expand);
}

- (void)setHoverSelection:(bool)hover
{
	gtk_tree_view_set_hover_selection(GTK_TREE_VIEW([self GOBJECT]), hover);
}
...
{
	gtk_tree_view_set_reorderable(GTK_TREE_VIEW([self GOBJECT]), reorderable);
}
...
{
	gtk_tree_view_set_rubber_banding(GTK_TREE_VIEW([self GOBJECT]), enable);
}

- (void)setRulesHint:(bool)setting
{
	gtk_tree_view_set_rules_hint(GTK_TREE_VIEW([self GOBJECT]), setting);
}
...
{
	gtk_tree_view_set_show_expanders(GTK_TREE_VIEW([self GOBJECT]), enabled);
}
