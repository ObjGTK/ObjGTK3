...
- (id)initWithTitle:(OFString*)title andParent:(OGTKWindow*)parent andAction:(GtkFileChooserAction)action andButtonTextResponseDictionary:(OFDictionary*)buttonTextDict
{
