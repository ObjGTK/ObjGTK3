...
- (OGTKWidget*)getColorSelection
{
	return [[OGTKWidget alloc] initWithGObject:(GObject*)gtk_color_selection_dialog_get_color_selection(GTK_COLOR_SELECTION_DIALOG([self GOBJECT]))];
}
